...
Route::middleware("AdminMiddleware", [
    ...
    Route::post("/admin/left_menu/save/main", "admin\LeftMenuController@save_main_item"),
    Route::post("/admin/left_menu/save/sub", "admin\LeftMenuController@save_sub_item"),
    Route::post("/admin/left_menu/add/main", "admin\LeftMenuController@add_main_item"),
    Route::post("/admin/left_menu/add/sub", "admin\LeftMenuController@add_sub_item"),
    Route::post("/admin/left_menu/delete/main", "admin\LeftMenuController@delete_main_item"),
    Route::post("/admin/left_menu/delete/sub", "admin\LeftMenuController@delete_sub_item"),
